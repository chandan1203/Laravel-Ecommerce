						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									@if ($manufacture->publication_status == 1)
									<a class="btn btn-danger" href="{{ url('/unactive_manufacture/'.$manufacture->manufacture_id) }}">
									...
									@endif
									<a class="btn btn-info" href="{{ url('/edit_manufacture/'.$manufacture->manufacture_id) }}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="{{ url('/delete_manufacture/'.$manufacture->manufacture_id) }}" id="delete" >
